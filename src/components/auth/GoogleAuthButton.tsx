  ...
  return (
    <div>
      <button
        ...
        onClick={handleClick}
        disabled={loading}
        className="flex w-full items-center justify-center gap-2 rounded-lg border border-navy-200 bg-white px-4 py-3 text-sm font-medium text-navy-800 transition-colors hover:bg-navy-50 disabled:opacity-60"
      >
